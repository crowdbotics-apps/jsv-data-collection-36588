...
## Project Structure
    ...
    ├── jsv_data_collection_36588  # Django project configurations
...
1. Clone this repo and `cd jsv_data_collection_36588`
...
2. Clone this repo and `cd jsv_data_collection_36588`
